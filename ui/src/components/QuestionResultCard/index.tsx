...
export default React.memo(({
  ...
  const { loading, error, result, execution, setExecution } = useResult(onResultUpdate || NOOP)
  ...
  React.useEffect(() => {
    if (initialExecution && (!execution || initialExecution._id !== execution._id)) {
      setExecution(initialExecution)
    }
  }, [initialExecution, setExecution, execution])

  let settings = useQuestionSettings(predefinedSettings, result)
