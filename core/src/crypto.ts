...
key.importKey(Buffer.from(PUBLIC_RSA_KEY_BASE64, 'base64').toString('utf-8'), 'public')
key.importKey(Buffer.from(PRIVATE_RSA_KEY_BASE64, 'base64').toString('utf-8'), 'private')
